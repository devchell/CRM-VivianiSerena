...
export default function OfflinePage() {
  return (
    <div className="min-h-screen bg-[#1C1C1C] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-20 h-20 rounded-lg bg-rose-gold/10 border border-rose-gold/20 flex items-center justify-center mb-6">
      ...
      <button
        ...
        className="px-6 py-3 bg-rose-gold text-white text-sm font-semibold rounded-md hover:bg-rose-gold/90 transition-colors"
      >
        Tentar novamente
      </button>
    </div>
