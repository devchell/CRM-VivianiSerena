  ...
  return (
    <div className="card-dark p-6 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="flex h-[220px] items-center justify-center rounded-2xl border border-dashed border-blush-200 text-sm text-charcoal-400 dark:border-charcoal-700 dark:text-charcoal-500">
