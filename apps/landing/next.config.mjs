...
function requireConfiguredUrl(name, value) {
  if (!value) {
...
const apiBaseUrl = requireConfiguredUrl('API_BASE_URL', process.env.API_BASE_URL ?? process.env.NEXT_PUBLIC_API_URL)
const crmUrl = requireConfiguredUrl('CRM_URL', process.env.CRM_URL)
...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      `img-src 'self' data: blob: ${apiOrigin} https://images.unsplash.com https://res.cloudinary.com https://www.google-analytics.com`,
