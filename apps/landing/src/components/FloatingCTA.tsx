    ...
    >
      ...
      >
        ...
        <div className="p-7">
          ...
          {/* Icon */}
          <div className="w-14 h-14 bg-blush rounded-full flex items-center justify-center mb-4" aria-hidden="true">
          ...
          <div className="space-y-3">
            <a
              ...
              className="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20b858] text-white font-semibold py-3.5 px-6 rounded-full transition-colors w-full"
            >
        ...
        {visible && (
          ...
          >
            <a
              ...
              className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20b858] rounded-full shadow-2xl transition-colors group"
            ...
            >
              ...
              {/* Tooltip */}
              <span className="absolute right-full mr-3 bg-charcoal text-white text-xs font-medium px-2.5 py-1.5 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-lg">
                Falar no WhatsApp
                <span className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-full border-4 border-transparent border-l-charcoal" aria-hidden="true" />
              </span>
            </a>
          </motion.div>
        )}
